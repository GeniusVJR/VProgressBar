package com.francis.vprogressbar.view;
...
import com.francis.vprogressbar.R;
...
public class HorizontalProgressbarWithProgress extends ProgressBar {
	...
	private static final int DEFAULT_HEIGHT_REACH = 10;  //dp
	...
	private void obtainStyledAttrs(AttributeSet attrs) {
		...
		mTextOffset = (int) ta.getDimension(R.styleable.HorizontalProgressbarWithProgress_progress_text_offset,
				mTextOffset);
		mUnReachColor = ta.getColor(R.styleable.HorizontalProgressbarWithProgress_progress_reach_color,
				mUnReachColor);
